...
class BaseClient:
    """Synchronous HTTP client for the OneBrain API."""
    ...
    def request(
        ...
        *,
        ...
        return self._request_with_retry(method, path, body=body, params=query)
    ...
    def request_paginated(
        ...
        *,
        ...
        query = self.build_query(params) if params else None
        raw = self._request_with_retry("GET", path, params=query)
    ...
    def _request_with_retry(
        ...
        *,
        ...
        for attempt in range(attempts):
            try:
                return self._execute(method, path, body=body, params=params)
    ...
    def _raise_for_status(
        ...
        message = error_body.get("message", response.reason_phrase or "Unknown error")
